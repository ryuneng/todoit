	...
	<div>
		...
		<h4>카테고리</h4>
    		...
    		<ul class="nav nav-pills flex-column mb-auto">
			     ...
			     <li class="nav-item">
			       <a class="nav-link <%="hostlist".equals(menu) ? "active" : "" %>" href="/host/management.jsp">
			         <svg class="bi me-2" width="16" height="16"></svg>
			        나의 개설모임
			       </a>
			     </li>
			     <li class="nav-item">
		      	 ...
		      	 <li class="nav-item">
			       <a class="nav-link <%="payment".equals(menu) ? "active" : "" %>" href="/info/userpayment.jsp">
			         <svg class="bi me-2" width="16" height="16"></svg>
			         결제내역
			       </a>
		      	 </li>
		      	 <li class="nav-item">
			       <a class="nav-link <%="myPoints".equals(menu) ? "active" : "" %>" href="myPoints.jsp">
			         <svg class="bi me-2" width="16" height="16"></svg>
			         포인트
			       </a>
		      	 </li>
