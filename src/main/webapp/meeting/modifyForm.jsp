...
%>
				...
				<div class="form-group mb-3">
					...
					<input type="text" class="form-control mb-1" name="address" value="<%= meeting.getAddress()%>"/>
					<input type="hidden" class="form-control" name="lat" value="<%=meeting.getLatitude()%>"/>
					<input type="hidden" class="form-control" name="lon" value="<%=meeting.getLongitude()%>"/>
